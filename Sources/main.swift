...
//    let x = try? HMAC(key: SECRET.utf8.map({$0}), variant: .sha256).authenticate(signa.utf8.map({$0}))
    ...
    let body = "<!DOCTYPE html><html class=\"h\"><head><meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\"/>"
            ...
            + "<title></title><style>.h, .h body, .h {margin:0;padding:0;background: #FFF;height: 100%;}#root {position: relative;}</style><script src=\"//vk.com/js/api/xd_connection.js?2\"  type=\"text/javascript\"></script></head><body><div id=\"root\"></div><script type=\"text/javascript\" src=\"vendor.1480193056011.js\"></script><script type=\"text/javascript\" src=\"app.1480193056011.js\"></script></body></html>"
